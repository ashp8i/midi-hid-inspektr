...
class CustomSplash(QSplashScreen):
    ...
    def draw_splash(self):
        ...
        painter.drawText(pixmap.rect().adjusted(0, 50, 0, 0), Qt.AlignHCenter | Qt.AlignTop, f"Version {self.version}")
        
        # Draw status text placeholder
        painter.drawText(pixmap.rect().adjusted(0, 250, 0, -10), Qt.AlignHCenter | Qt.AlignBottom, "Initializing...")
    ...
    def showMessage(self, message, alignment=Qt.AlignBottom | Qt.AlignHCenter, color=Qt.white):
        ...
        painter.drawText(pixmap.rect().adjusted(0, 0, 0, -10), Qt.AlignHCenter | Qt.AlignBottom, message)
